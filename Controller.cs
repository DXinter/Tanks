...
namespace Tanks_v1._0
{
    ...
    {      
        ...
        {
            DialogResult dr = MessageBox.Show("Приложение будет закрыто. Вы уверены?", "Tanks", MessageBoxButtons.YesNo);
        ...
        private void SoundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            isSound = !isSound;
            if (isSound)
                soundToolStripMenuItem.Image = global::Tanks_v1._0.Properties.Resources.audio_violume_sound_icon_124173;
            else
                soundToolStripMenuItem.Image = global::Tanks_v1._0.Properties.Resources.sound_mute;
        }
    }
}
